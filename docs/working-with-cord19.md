...
wget https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-26/document_parses.tar.gz -P "${DATA_DIR}"
wget https://ai2-semanticscholar-cord-19.s3-us-west-2.amazonaws.com/2020-05-26/metadata.csv -P "${DATA_DIR}"

...
+ Results reproduced by [@mahdijaf](https://github.com/mahdijaf) on 2026-03-15 (commit [`b733137`](https://github.com/castorini/pyserini/commit/b733137cc8391a7c6e23f87fc352629d6d07a52c)). Environment: Windows 11, Python 3.11, Java 21, local Pyserini development build, CPU inference. Downloaded and prepared NFCorpus, encoded documents with BAAI/bge-base-en-v1.5, built a Faiss index, reproduced dense retrieval, obtained **ndcg_cut_10 = 0.3821**, and verified interactive search using FaissSearcher.
+ Results reproduced by [@mahdijaf](https://github.com/mahdijaf) on 2026-03-15 (commit [`34cd9d7`](https://github.com/castorini/pyserini/commit/34cd9d745c67a692f13132e12064f209e497e554)). Environment: Windows 11, Python 3.11, Java 21, local Pyserini development build. Reproduced dense retrieval and sparse retrieval on NFCorpus, verified dense vector reconstruction from Faiss, verified BM25 vector reconstruction from Lucene, reproduced query-document dot products by hand, and matched brute-force rankings against both FaissSearcher and LuceneSearcher. Dense run: ndcg_cut_10 = 0.3821. BM25 run: ndcg_cut_10 = 0.3231.

...
+ Results reproduced by [@agnesoyedokun](https://github.com/agnesoyedokun) on 2026-08-22 (commit [`9a5330a`](https://github.com/castorini/pyserini/commit/9a5330a2dcbabda99ccf70c6237a7caa92d5cef4)): Ubuntu/WSL, Python 3.12.14, Pyserini 2.4.0, OpenJDK 21.0.12; BGE-base-en-v1.5 dense retrieval over the NFCorpus collection with 3,633 documents and 3,237 queries. Reproduced nDCG@10=0.3808; interactive query "How to Help Prevent Abdominal Aortic Aneurysms" returned MED-4555 at score 0.791378.

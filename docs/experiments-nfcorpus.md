...
+ Results reproduced by [@agnesoyedokun](https://github.com/agnesoyedokun) on 2026-08-22 (commit [`9a5330a`](https://github.com/castorini/pyserini/commit/9a5330a2dcbabda99ccf70c6237a7caa92d5cef4)): Ubuntu/WSL2, Python 3.12, BAAI/bge-base-en-v1.5 on CPU with mean pooling and L2 normalization; Faiss index `indexes/nfcorpus.bge-base-en-v1.5` containing 3,633 documents. Retrieved 3,237 queries with 1,000 hits; reproduced nDCG@10=0.3808.
+ Results reproduced by [@agnesoyedokun](https://github.com/agnesoyedokun) on 2026-08-22 (commit [`9a5330a`](https://github.com/castorini/pyserini/commit/9a5330a2dcbabda99ccf70c6237a7caa92d5cef4)): Ubuntu/WSL, Python 3.12, NumPy 1.26.4, FAISS 1.8.0, Transformers 4.46.3. Compared dense BGE retrieval with a Lucene BM25 index containing 3,633 NFCorpus documents. Dense nDCG@10=0.3808 versus sparse BM25 nDCG@10=0.3218; manual BM25 scoring reproduced the Lucene top-10 ranking. Transformers compatibility required downgrading from 5.16.1 to 4.46.3 and a temporary NumPy compatibility shim for `np.long`/`np.ulong`.

...
+ Results reproduced by [@k22mitta](https://github.com/k22mitta) on 2026-06-27 (commit [`6d03d1e`](https://github.com/castorini/pyserini/commit/6d03d1e)) (nDCG@10: 0.3681; note: slightly lower than expected due to pyserini version incompatibility requiring workaround without --l2-norm)

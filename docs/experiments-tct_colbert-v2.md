...
|:----------|-------:|----:|------------:|
| TCT_ColBERT-V2 (brute-force index) |  0.3439 (0.3435) | 0.3509 | 0.9670 |
...
To perform on-the-fly query encoding with our [pretrained encoder model](https://huggingface.co/castorini/tct_colbert-v2-msmarco/tree/main) use the option `--encoder castorini/tct_colbert-v2-hnp-msmarco`.

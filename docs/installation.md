...
Follow the most up-to-date solution of the issue [here](https://github.com/nmslib/nmslib/issues/476)

=======
>>>>>>> parent of 682f5e1 (Found issue with nmslib on M-series chip and attached solution with github issue link)

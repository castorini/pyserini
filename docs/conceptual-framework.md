...
+ Results reproduced by [@agnesoyedokun](https://github.com/agnesoyedokun) on 2026-08-22 (commit [`9a5330a`](https://github.com/castorini/pyserini/commit/9a5330a2dcbabda99ccf70c6237a7caa92d5cef4)): Ubuntu/WSL, Python 3.12.14, Pyserini 2.4.0, OpenJDK 21.0.12; BM25 k1=0.82, b=0.68. For query "what is paula deen's brother", the tokenized query was ['what', 'paula', 'deen', 'brother']; the sparse BM25 vector inner product was 17.9494876862, matching Lucene's top score 17.94950 and reproducing the same top-10 ranking.

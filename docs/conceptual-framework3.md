...
+ Results reproduced by [@agnesoyedokun](https://github.com/agnesoyedokun) on 2026-08-22 (commit [`9a5330a`](https://github.com/castorini/pyserini/commit/9a5330a2dcbabda99ccf70c6237a7caa92d5cef4)): Ubuntu/WSL, Python 3.12; gated `naver/splade-v3` access authenticated through Hugging Face; encoded 3,633 NFCorpus documents and built a Lucene impact index with no errors. Retrieved all 3,237 queries and reproduced nDCG@10=0.3624. A Transformers GenerationMixin warning and the temporary NumPy compatibility shim were non-blocking.

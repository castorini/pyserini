...
## Index
Here we provide instructions to reproduce index building.
Since we provide prebuilt indexes, if you want to reproduce search directly, you can skip this section.

### Passage V2
Download sparse representation of the corpus generated by uniCOIL.
```bash
...
### Document V2
Download sparse representation of the corpus segmentation generated by uniCOIL.
```bash
...
## Search
Lucene index for uniCOIL can be generated by following above steps, or download our prebuilt index.

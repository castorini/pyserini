# Pyserini Release Notes (v0.42.0)
...
+ Refactored PyPI Packaging: fixed issue with missing `pyserini.2cr` in distribution.
+ Refactored documentation: installation, search usage, fetching documents.

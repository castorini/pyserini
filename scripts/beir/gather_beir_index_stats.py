...
for key in beir_keys:
    index_reader = IndexReader(f'indexes/faiss.beir-v1.0.0-{key}.contriever-ft.{date}')
    stats = index_reader.stats()
    md5 = compute_md5(f'indexes/faiss.beir-v1.0.0-{key}.contriever-ft.{date}.tar.gz')
    size = os.path.getsize(f'indexes/faiss.beir-v1.0.0-{key}.contriever-ft.{date}.tar.gz')
    print(f'    "beir-v1.0.0-{key}.contriever": {{')
    ...
    print(f'        "filename": "faiss.beir-v1.0.0-{key}.contriever-ft.{date}.tar.gz",')
    print(f'        "readme": "faiss.beir-v1.0.0-{key}.contriever-ft.{date}.README.md",')
    print(f'        "urls": [')
    print(f'            "https://rgw.cs.uwaterloo.ca/pyserini/indexes/faiss.beir-v1.0.0-{key}.contriever-ft.20230124.tar.gz"')
    print(f'        ],')
    print(f'        "md5": "{md5}",')
    print(f'        "size compressed (bytes)": {size},')
    print(f'        "documents": {stats["documents"]},')

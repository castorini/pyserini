...
class TestSearchPyJass(unittest.TestCase):
    def setUp(self):
        ...
        self.collection_url = 'https://github.com/castorini/anserini-data/raw/master/CACM/lucene-index.cacm.tar.gz' # to be replaced
        ...
        self.searcher = JASSv2Searcher(f'{self.index_dir}lucene-index.cacm')

...
def read_file_lines(path):
    with open(path) as f:
        return [line.rstrip() for line in f if line != '\n']
...
class TestGetQrels(unittest.TestCase):
    ...
    def test_robust04(self):
        ...
        self.assertEqual(311410, length)

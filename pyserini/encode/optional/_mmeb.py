...
class MMEBCorpusEncoder:
    def __init__(
        ...
        self.corpus_encoder = CorpusEncoder(model_name=model_name, device=device, pooling=pooling, l2_norm=False)
...
class MMEBQueryEncoder:
    def __init__(
        ...
        **kwargs: Any,
        ...
        self.l2_norm = l2_norm
        # Let Faiss handle the L2 normalization, since it should only happen on fp32 embeddings.
        self.query_encoder = QueryEncoder(model_name=encoder_dir, device=device, pooling=pooling, l2_norm=False)

KILT_QUERY_INFO = {
    "fever-dev-kilt": {
        "description": "KILT FEVER queries",
    ...
    "aidayago2-dev-kilt": {
        "description": "KILT AIDA CoNLL-YAGO queries",
    ...
    "wned-dev-kilt": {
        "description": "KILT WNED-WIKI queries",
    ...
    "cweb-dev-kilt": {
        "description": "KILT WNED-CWEB queries",
    ...
    "trex-dev-kilt": {
        "description": "KILT T-REx queries",
    ...
    "structured_zeroshot-dev-kilt": {
        "description": "KILT Zero-Shot RE queries",
    ...
    "nq-dev-kilt": {
        "description": "KILT Natural Questions queries",
    ...
    "hotpotqa-dev-kilt": {
        "description": "KILT HotpotQA queries",
    ...
    "wow-dev-kilt": {
        "description": "KILT Wizard of Wikipedia queries",

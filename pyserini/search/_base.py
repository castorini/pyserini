...
topics_mapping = {
    ...
    'beir-v1.0.0-bioasq.test.splade-pp-ed': JTopics.BEIR_V1_0_0_BIOASQ_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-nfcorpus.test.splade-pp-ed': JTopics.BEIR_V1_0_0_NFCORPUS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-nq.test.splade-pp-ed': JTopics.BEIR_V1_0_0_NQ_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-hotpotqa.test.splade-pp-ed': JTopics.BEIR_V1_0_0_HOTPOTQA_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-fiqa.test.splade-pp-ed': JTopics.BEIR_V1_0_0_FIQA_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-signal1m.test.splade-pp-ed': JTopics.BEIR_V1_0_0_SIGNAL1M_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-trec-news.test.splade-pp-ed': JTopics.BEIR_V1_0_0_TREC_NEWS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-robust04.test.splade-pp-ed': JTopics.BEIR_V1_0_0_ROBUST04_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-arguana.test.splade-pp-ed': JTopics.BEIR_V1_0_0_ARGUANA_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-webis-touche2020.test.splade-pp-ed': JTopics.BEIR_V1_0_0_WEBIS_TOUCHE2020_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-android.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_ANDROID_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-english.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_ENGLISH_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-gaming.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_GAMING_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-gis.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_GIS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-mathematica.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_MATHEMATICA_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-physics.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_PHYSICS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-programmers.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_PROGRAMMERS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-stats.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_STATS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-tex.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_TEX_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-unix.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_UNIX_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-webmasters.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_WEBMASTERS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-cqadupstack-wordpress.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CQADUPSTACK_WORDPRESS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-quora.test.splade-pp-ed': JTopics.BEIR_V1_0_0_QUORA_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-dbpedia-entity.test.splade-pp-ed': JTopics.BEIR_V1_0_0_DBPEDIA_ENTITY_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-scidocs.test.splade-pp-ed': JTopics.BEIR_V1_0_0_SCIDOCS_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-fever.test.splade-pp-ed': JTopics.BEIR_V1_0_0_FEVER_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-climate-fever.test.splade-pp-ed': JTopics.BEIR_V1_0_0_CLIMATE_FEVER_TEST_SPLADE_PP_ED,
    'beir-v1.0.0-scifact.test.splade-pp-ed': JTopics.BEIR_V1_0_0_SCIFACT_TEST_SPLADE_PP_ED,

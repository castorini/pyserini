...
parser.add_argument('--prcl.vectorizer',  dest='vectorizer', type=str, help='E.g. TfidfVectorizer')
...
if use_prcl is True:
    ranker = PseudoRelevanceClassifierReranker(args.index, args.vectorizer, args.prcl, r=args.r, n=args.n, alpha=args.alpha)

...
JQueryGenerator, JSimpleNearestNeighborSearcherResult, JSimpleNearestNeighborSearcher, JQuery, JIndexSearcher, JIndexReader
...
class SimpleSearcher:
    ...
    def __init__(self, index_dir: str):
        ...
        JSearch = JIndexSearcher()
        self.maxDoc = JSearch.getIndexReader().maxDoc()

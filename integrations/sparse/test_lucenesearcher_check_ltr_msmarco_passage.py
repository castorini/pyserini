...
class TestLtrMsmarcoPassage(unittest.TestCase):
    def test_reranking(self):
        ...
        os.system(f'python -m pyserini.search.lucene.ltr --model ltr_test/msmarco-passage-ltr-mrr-v1 --data passage --index msmarco-passage-ltr --ibm-model ltr_test/ibm_model/ --output-format tsv --output ltr_test/{outp}')

...
class TestLtrMsmarcoPassage(unittest.TestCase):
    def test_reranking(self):
        ...
        #queries process
        os.system(f'python -m pyserini.search.lucene.ltr --model ltr_test/msmarco-passage-ltr-mrr-v1 --topic passage --index msmarco-passage-ltr --ibm-model ltr_test/ibm_model/ --output-format tsv --output ltr_test/{outp}')

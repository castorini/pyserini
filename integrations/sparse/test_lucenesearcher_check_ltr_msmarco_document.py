...
class TestLtrMsmarcoDocument(unittest.TestCase):
    def test_reranking(self):
        ...
        os.system(f'python -m pyserini.search.lucene.ltr --topic tools/topics-and-qrels/topics.msmarco-doc.dev.txt --model ltr_test/msmarco-passage-ltr-mrr-v1/ --qrel tools/topics-and-qrels/qrels.msmarco-doc.dev.txt --index msmarco-doc-per-passage-ltr --ibm-model ltr_test/ibm_model/ --data document --output ltr_test/{outp} --max-passage --hits 10000')

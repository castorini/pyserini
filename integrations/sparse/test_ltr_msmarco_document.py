...
class TestLtrMsmarcoDocument(unittest.TestCase):
    def test_reranking(self):
        ...
        os.system(f'python scripts/ltr_msmarco/ltr_inference.py  --input ltr_test/{inp} --input-format trec --data document --model ltr_test/model-ltr-msmarco-passage-mrr-v1 --index ~/.cache/pyserini/indexes/index-msmarco-doc-per-passage-ltr-20211031-33e4151.bd60e89041b4ebbabc4bf0cfac608a87 --ibm-model ltr_test/model-ltr-ibm/ --queries ltr_test --output ltr_test/{outp}')

...
class TestSearchIntegration(unittest.TestCase):
    ...
    def test_bm25_rm3(self):
        self.assertTrue(self.checker.run('robust04_bm25', '-bm25 -rm3', '--bm25 --rm3'))

    def test_qld(self):
        self.assertTrue(self.checker.run('robust04_bm25', '-qld', '--qld'))

    def test_qld_rm3(self):
        self.assertTrue(self.checker.run('robust04_bm25', '-qld -rm3', '--qld --rm3'))

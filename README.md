...
+ Reproducing [uniCOIL experiments with doc2query-T5 expansions for MS MARCO V1 Collections](docs/experiments-unicoil.md)
+ Reproducing [uniCOIL experiments with doc2query-T5 expansions for MS MARCO V2 Collections](docs/experiments-msmarco-v2-unicoil.md)
